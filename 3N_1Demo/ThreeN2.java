...
public class ThreeN2 {
    ...
    public static void main(String[] args) {
        ...
        Scanner stdin = new Scanner(System.in); // get keyboard channel
        ...
        stdin.close(); // close keyboard channel
    }
     ...
     */
    private static void print3NSequence(int startingValue) {
    ...
    */
    private static int nextN(int currentN) {
        if (currentN % 2 == 1)
          return 3 * currentN + 1;
       else
          return currentN / 2;
